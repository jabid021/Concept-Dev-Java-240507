...
//			authorize.requestMatchers("/api/utilisateur/**").permitAll(); // Autorisé à tout le monde
			...
			authorize.requestMatchers("/api/hello", "/api/utilisateur/**","/swagger-ui/**","/v3/**","/swagger-ui.html").permitAll(); // Autorisé à tout le monde
...
//		http.formLogin(csrf.d.withDefaults());
