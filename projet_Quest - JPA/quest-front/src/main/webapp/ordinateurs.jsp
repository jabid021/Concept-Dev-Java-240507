  ...
  <table class="table table-striped">
	...
	<tbody>
		...
		<tr>
	        ...
	        <td>
        		<a href="ordinateur?id=${ordinateur.id}"><input type="button" class ="btn btn-warning" value="Modifier"></a><a href="ordinateur?id=${ordinateur.id}&delete"><input type="button" class ="btn btn-danger" value="Supprimer"></a>
        	</td>
      	</tr>
		</core:forEach>
  </table>
