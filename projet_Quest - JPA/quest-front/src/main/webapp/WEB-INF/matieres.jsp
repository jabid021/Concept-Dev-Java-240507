	...
	<main class="container my-5">
		...
		<section id="listeSMatieres" style="display: block">
			<div class="gap-4 mt-5 d-flex">
				<button class="btn btn-primary" id="ajoutermatiereBtn">Ajouter</button>
			...
			<div class="mx-auto" style="max-width: 680px">
				<form class="gap-4 mx-auto d-flex flex-column" action="matiere" method="POST">
					...
					<div class="d-flex justify-content-end">
						<button id="modifiermatiereBtn" class="btn btn-primary me-2" type="submit">Ajouter matière</button>
